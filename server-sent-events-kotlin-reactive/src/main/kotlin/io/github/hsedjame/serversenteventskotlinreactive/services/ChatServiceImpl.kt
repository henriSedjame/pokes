...
@Service
data class ChatServiceImpl(private val chatSink: Sinks.Many<ChatEvent>, private val state: ChatState) : ChatService {

    override suspend fun onNewUser(name: String) {
    ...
    override suspend fun onNewMessage(sender: String, message: String) {
